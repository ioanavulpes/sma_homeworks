...
import com.example.todolist.di.DatabaseModule_ProvideTodoDaoFactory;
import com.example.todolist.di.DatabaseModule_ProvideTodoDatabaseFactory;
import com.example.todolist.ui.viewmodel.TodoViewModel;
import com.example.todolist.ui.viewmodel.TodoViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerTodoApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends TodoApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.todoViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.todolist.ui.viewmodel.TodoViewModel", ((Provider) todoViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.todolist.ui.viewmodel.TodoViewModel 
  ...
  private static final class SingletonCImpl extends TodoApplication_HiltComponents.SingletonC {
    ...
    private TodoDao todoDao() {
      return DatabaseModule_ProvideTodoDaoFactory.provideTodoDao(provideTodoDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.todoRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TodoRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.todolist.data.repository.TodoRepository 
          return (T) new TodoRepository(singletonCImpl.todoDao());

          case 1: // com.example.todolist.data.local.TodoDatabase 
          return (T) DatabaseModule_ProvideTodoDatabaseFactory.provideTodoDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
